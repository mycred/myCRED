...
if (! defined('WP_FS__IS_HTTPS') ) {
    define(
        'WP_FS__IS_HTTPS', ( WP_FS__IS_HTTP_REQUEST &&
...
if (! defined('WP_FS__IS_POST_REQUEST') ) {
    define(
        'WP_FS__IS_POST_REQUEST', ( WP_FS__IS_HTTP_REQUEST &&
...
if (! defined('WP_FS__IS_LOCALHOST') ) {
    if (defined('WP_FS__LOCALHOST_IP') ) {
        ...
        define(
            'WP_FS__IS_LOCALHOST', WP_FS__IS_HTTP_REQUEST &&
...
if (! defined('WP_FS__IS_LOCALHOST_FOR_SERVER') ) {
    define(
        'WP_FS__IS_LOCALHOST_FOR_SERVER', ( ! WP_FS__IS_HTTP_REQUEST ||
