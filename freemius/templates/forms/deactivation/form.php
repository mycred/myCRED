...
(function ($) {
                ...
                $.ajax({
                    ...
                    success: function( result ) {
                        if ( result.success ) {
                            ...
                            $subscriptionCancellationModal.find( '.fs-modal-footer .button-primary' ).html( <?php echo json_encode(
                                sprintf(
    ...
    function updateButtonLabels() {
        ...
        if ( 'confirm' === getCurrentPanel() ) {
            $deactivateButton.text( <?php echo json_encode(
                sprintf(
            ...
            $deactivateButton.html( <?php echo json_encode(
                sprintf(
