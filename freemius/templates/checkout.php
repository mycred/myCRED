        ...
        <script type="text/javascript">
            ...
            (function ($) {
                $(function () {
                    ...
                    FS.PostMessage.receiveOnce('purchaseCompleted', <?php echo $fs->apply_filters(
                        'checkout/purchaseCompleted', 'function (data) {
