...
<div class="fs-modal fs-modal-auto-install">
    <div class="fs-modal-dialog">
        ...
        <div class="fs-modal-footer">
            ...
            <button
                class="button button-secondary button-cancel"><?php fs_esc_html_echo_inline('Cancel Installation', 'cancel-installation', $slug) ?><?php if (! $require_credentials ) : ?> (<?php echo $countdown_html ?>)<?php 
               endif ?></button>
            <button
