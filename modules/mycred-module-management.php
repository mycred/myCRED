...
if (! class_exists('myCRED_Management_Module') ) :
    class myCRED_Management_Module extends myCRED_Module
    {
        ...
        public function __construct( $type = MYCRED_DEFAULT_TYPE_KEY )
        {
            ...
            parent::__construct(
                'myCRED_Management_Module', array(
        ...
        <tr>
            ...
            foreach ( $balances as $point_type => $data ) {
                ...
                // Eligeble user
                    ...
                    <?php if ($data['can_edit'] ) : ?><div class="toggle-mycred-balance-editor"><a href="javascript:void(0);" data-type="<?php echo $point_type; ?>" data-view="<?php _e('Edit', 'mycred'); ?>" data-edit="<?php _e('Cancel', 'mycred'); ?>"><?php _e('Edit', 'mycred'); ?></a></div><?php 
                    endif; ?>
                        <div><?php echo $data['name']; ?></div>
                        <div class="balance-row" id="mycred-balance-<?php echo $point_type; ?>">
                            <div class="balance-view"><?php echo $data['formatted']; ?></div>
                    <?php if ($data['can_edit'] ) : ?><div class="balance-edit"><input type="text" name="mycred_new_balance[<?php echo $point_type; ?>]" value="" placeholder="<?php echo $data['raw']; ?>" size="12" /></div><?php 
                    endif; ?>
                        </div>
                    <?php
...
<div id="edit-mycred-balance" style="display: none;">
                <?php if ($name == 'myCRED' ) : ?><img id="mycred-token-sitting" class="hidden-sm hidden-xs" src="<?php echo plugins_url('assets/images/token-sitting.png', myCRED_THIS); ?>" alt="Token looking on" /><?php 
                endif; ?>
