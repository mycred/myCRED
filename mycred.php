...
if (! class_exists('myCRED_Core') ) :
    final class myCRED_Core
    {
        ...
        {
            _doing_it_wrong(__FUNCTION__, 'Cheatin&#8217; huh?', '2.4.4.2'); 
        }
        ...
        private function define( $name, $value, $definable = true )
        {
            if (! defined($name) ) {
                ...
                _doing_it_wrong('myCRED_Core->define()', 'Could not define: ' . $name . ' as it is already defined somewhere else!', '2.4.4.2');
            }
        }
        ...
        public function file( $required_file )
        {
            if (file_exists($required_file) ) {
                ...
                _doing_it_wrong('myCRED_Core->file()', 'Requested file ' . $required_file . ' not found.', '2.4.4.2');
            }
        }
