...
if ( ! class_exists( 'myCRED_Core' ) ) :
	final class myCRED_Core {
		 ...
		 * @version 1.0
		 */
		public function __clone() { _doing_it_wrong( __FUNCTION__, 'Cheatin&#8217; huh?', '2.5.2' ); }
		 ...
		 * @version 1.0
		 */
		public function __wakeup() { _doing_it_wrong( __FUNCTION__, 'Cheatin&#8217; huh?', '2.5.2' ); }
		...
		private function define( $name, $value, $definable = true ) {
			...
			elseif ( ! $definable && defined( $name ) )
				_doing_it_wrong( 'myCRED_Core->define()', 'Could not define: ' . esc_html( $name ) . ' as it is already defined somewhere else!', '2.5.2' );
		}
		...
		public function file( $required_file ) {
			if ( file_exists( $required_file ) )
				...
				_doing_it_wrong( 'myCRED_Core->file()', 'Requested file ' . esc_html( $required_file ) . ' not found.', '2.5.2' );
		}
