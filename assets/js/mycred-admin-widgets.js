...
(function ($) {
    ...
    wpWidgets = {
        ...
        init : function () {
            ...
            $('#widgets-right .sidebar-name').click(
                function () {
                    var $this = $(this),
            ...
            $('#widgets-left .sidebar-name').click(
                function () {
            ...
            $(document.body).bind(
                'click.widgets-toggle', function (e) {
                    var target = $(e.target),
                    css = { 'z-index': 100 },
            ...
            $('#available-widgets .widget .widget-title').on(
                'click.widgets-chooser', function () {
                    ...
                    if ($widget.hasClass('widget-in-question') || $('#widgets-left').hasClass('chooser') ) {
                        ...
                        selectSidebar.find('li').on(
                            'focusin.widgets-chooser', function () {
            ...
            // Add event handlers
            chooser.on(
                'click.widgets-chooser', function ( event ) {
                ...
                'keyup.widgets-chooser', function ( event ) {
