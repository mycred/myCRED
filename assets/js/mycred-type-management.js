...
jQuery(
    function ($) {
         ...
         * Empty Log Trigger
         */
        $('#mycred-manage-action-empty-log').click(
            function () {
         ...
         */
        $('#mycred-manage-action-reset-accounts').click(
            function () {
        ...
        $(document).ready(
            function () {
                ...
                $('#mycred-image-setup').on(
                    'click', '#point-type-change-default-image', function (e) {
                 ...
                 */
                $('#mycred-export-users-points').click(
                    function () {
         ...
         */
        $('#mycred-adjust-decimal-places').change(
            function () {
         ...
         */
        $('#mycred-update-log-decimals').click(
            function () {
         ...
         * Clear Cache Trigger
         */
        $('button.clear-type-cache-button').click(
            function () {
