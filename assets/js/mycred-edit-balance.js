    ...
    function ($) {
        ...
        $(document).ready(
            function () {
                 ...
                 * Toggle Editor
                 */
                $('.mycred-open-points-editor').click(
                    function (e) {
                            ...
                            $.ajax(
                                {
                                    ...
                                    success    : function ( response ) {
                                        ...
                                        $('#mycred-users-mini-ledger .border #mycred-processing').slideUp(
                                            function () {
                 ...
                 * Editor Submit
                 */
                $('form#mycred-editor-form').submit(
                    function (e) {
