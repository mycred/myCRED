...
jQuery(
    function ($) {
        ...
        function mycred_reset_editor()
        {
            ...
            $.each(
                myCREDLog.references, function ( index ) {
        ...
        function mycred_animate_row_deletion( rowtoanimate )
        {
            ...
            rowtodelete.addClass('deleted-row').fadeOut(
                2000, function () {
                    rowtodelete.remove();
                }
            );
        ...
        function mycred_animate_row_update( newrow )
        {
            ...
            affectedrow.addClass('updated-row').fadeOut(
                function () {
                    affectedrow.empty().append(newrow).fadeIn(
                        2000, function () {
        ...
        $(document).ready(
            function () {
                 ...
                 */
                $('tbody#the-list').on(
                    'click', '.mycred-open-log-entry-editor', function (e) {
                 ...
                 */
                $('tbody#the-list').on(
                    'click', '.mycred-delete-row', function () {
                ...
                $('#mycred-delete-entry-in-editor').on(
                    'click', function (e) {
                 ...
                 */
                $('#edit-mycred-log-entry').on(
                    'submit', 'form#mycred-editor-form', function (e) {
        ...
        $('#myCRED-wrap form table thead .check-column input').click(
            function (e) {
