...
if (! class_exists('myCRED_Sell_Content_Module') ) :
    class myCRED_Sell_Content_Module extends myCRED_Module
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(
                'myCRED_Sell_Content_Module', array(
        ...
        <td>
            ...
            foreach ( $available_options as $point_type => $data ) {
                ...
                <div class="mycred-wrapper buycred-wrapper color-option selected">
                    ...
                    <div class="balance-row">
                        <div class="balance-view"><input type="text" size="8" name="mycred_sell_this[<?php echo $point_type; ?>]" class="half" placeholder="<?php echo esc_attr($data['default']); ?>" value="<?php if ($data['override'] ) { echo esc_attr($data['custom']);
} ?>" /> %</div>
...
<div class="body" style="display:none;">
            ...
            <div id="<?php echo $this->field_id(array( 'post_types' => $post_type )); ?>-wrap" style="display: <?php echo $show_options; ?>;">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                        <div id="post-type-filter-<?php echo $post_type; ?>" style="display: <?php if (! in_array($settings['by'], array( 'all', 'manual' )) ) { echo 'block'; 
} else { echo 'none';
                                                  } ?>;">
                            <div class="form-group">
                                <input type="text" name="<?php echo $this->field_name(array( 'filters' => $post_type )); ?>[list]" value="<?php echo esc_attr($settings['list']); ?>" placeholder="<?php if (array_key_exists($settings['by'], $options) ) { echo esc_attr($options[ $settings['by'] ]['data']);
} ?>" class="form-control" />
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            wp_editor(
                $this->sell_content['templates']['members'], $this->field_id(array( 'templates' => 'members' )), array(
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            wp_editor(
                $this->sell_content['templates']['cantafford'], $this->field_id(array( 'templates' => 'cantafford' )), array(
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            wp_editor(
                $this->sell_content['templates']['visitors'], $this->field_id(array( 'templates' => 'visitors' )), array(
        ...
        <div class="row row-narrow">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group slim">
                    <label for="mycred-sell-this-<?php echo $point_type; ?>-status" class="slim"><input type="checkbox" name="mycred_sell_this[<?php echo $point_type; ?>][status]" id="mycred-sell-this-<?php echo $point_type; ?>-status"<?php if ($sale_setup['status'] === 'enabled' ) { echo ' checked="checked"';
} ?> value="enabled" class="toggle-setup" data-type="<?php echo $point_type; ?>" /> <?php printf(__('Sell using %s', 'Point types name', 'mycred'), $mycred->plural()); ?></label>
                </div>
            </div>
        </div>
        <div class="cover">
            <div class="row row-narrow padded-row mycred-sell-setup-container" id="mycred-sell-content-<?php echo $point_type; ?>-wrap" style="display: <?php if ($sale_setup['status'] === 'enabled' ) { echo 'block'; 
} else { echo 'none';
                                                                                                       } ?>;">
