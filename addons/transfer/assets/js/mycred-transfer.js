...
(function ($) {
    ...
    var mycred_transfer_autofill = $('input.mycred-autofill').autocomplete(
        {
            ...
            source    : function ( request, response ) {
                ...
                $.getJSON(
                    myCREDTransfer.ajaxurl, send, function ( data, status, xhr ) {
    ...
    // @since 1.6.3
    $('html body').on(
        'submit', 'form.mycred-transfer-form', function (e) {
            ...
            $.ajax(
                {
                    ...
                    beforeSend : function () {
                        ...
                        $(formid + ' input.form-control').each(
                            function (index) {
