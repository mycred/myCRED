    ...
    class myCRED_Transfer_Module extends myCRED_Module
    {
        ...
        public function maybe_load_script()
        {
            ...
            $messages = apply_filters(
                'mycred_transfer_messages', array(
...
<div class="body" style="display:none;">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            wp_editor(
                $settings['templates']['login'], $this->field_id(array( 'templates' => 'login' )), array(
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            wp_editor(
                $settings['templates']['limit'], $this->field_id(array( 'templates' => 'limit' )), array(
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            wp_editor(
                $settings['templates']['balance'], $this->field_id(array( 'templates' => 'balance' )), array(
