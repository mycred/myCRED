    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <div>
                    <input type="text" name="mycred_coupon[min_balance]" <?php if (count($this->point_types) > 1 ) { echo 'size="8"'; 
} else { echo ' style="width: 99%;"';
                                                                         } ?> id="mycred-coupon-min_balance" value="<?php echo $mycred->number($coupon->requires_min['value']); ?>" />
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <div>
                    <input type="text" name="mycred_coupon[max_balance]" <?php if (count($this->point_types) > 1 ) { echo 'size="8"'; 
} else { echo ' style="width: 99%;"';
                                                                         } ?> id="mycred-coupon-max_balance" value="<?php echo $mycred->number($coupon->requires_max['value']); ?>" />
        ...
        public function mycred_coupon_badges_ranks( $post )
        {
            ...
            <div class="mycred-badge-rank-hide-show">
                ...
                wp_localize_script(
                    'mycred-coupon-badge-rank-js', 'mycred_coupon_object', 
                    array( 
                    'html' => $html,
                    )
                );
