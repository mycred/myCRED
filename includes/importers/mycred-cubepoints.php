...
if ( ! class_exists( 'myCRED_Importer_CubePoints' ) ) :
	class myCRED_Importer_CubePoints extends WP_Importer {
		...
		public function header() {
			...
			echo '<div class="wrap"><h1>' . sprintf( __( 'Import CubePoints', 'mycred' ), '<a href="' . $this->documentation . '" target="_blank" class="page-title-action">' . __( 'Documentation', 'mycred' ) . '</a>' ) . '</h1>';
