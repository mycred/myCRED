...
if (! class_exists('myCRED_Hook_Affiliate') ) :
    class myCRED_Hook_Affiliate extends myCRED_Hook
    {
        ...
        function __construct( $hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY )
        {
            ...
            $this->limit_by = apply_filters(
                'mycred_affiliate_limit_by', array(
        ...
        public function site_visits()
        {
            ...
            if ($user_id !== null && ! is_user_logged_in() ) {
                ...
                $IP = apply_filters('mycred_affiliate_IP', sanitize_text_field($_SERVER['REMOTE_ADDR']), 'visit', $this);
                if ($IP != '' && $IP != '0.0.0.0' ) {
        ...
        public function site_signup( $new_user_id )
        {
            ...
            // Attempt to get the users IP
            $IP = apply_filters('mycred_affiliate_IP', sanitize_text_field($_SERVER['REMOTE_ADDR']), 'signup', $this);
