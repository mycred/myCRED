...
if (! class_exists('myCRED_Install') ) :
    final class myCRED_Install
    {
        ...
        {
            _doing_it_wrong(__FUNCTION__, 'Cheatin&#8217; huh?', '1.7'); 
        }
        ...
        public static function activate()
        {
            ...
            include_once myCRED_INCLUDES_DIR . 'mycred-setup.php';
        ...
        public static function uninstall()
        {
            ...
            $mycred_crons_to_clear = apply_filters(
                'mycred_uninstall_schedules', array(
                'mycred_reset_key',
